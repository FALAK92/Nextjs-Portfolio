...
export default function ProjectCard({
                                    tags, title, imageUrl, description,
                                }: ProjectProps) {
    ...
    return (
        <motion.div
            ...
            <section
                ...
                <Image
                    src={imageUrl}
                    alt={'ProjectCard i worked'}
                    quality={95}
                    width={400}
                    height={100}
                    className={'absolute hidden sm:block top-8 -right-40 rounded-t-lg shadow-2xl transition group-hover:scale-[1.04] group-hover:-translate-x-3group-hover:translate-y-3group-hover:-rotate-2group-even:group-hover:translate-x-3group-even:group-hover:translate-y-3group-even:group-hover:rotate-2 group-even:right-[initial] group-even:-left-40'}
                />
            </section>
        </motion.div>
    )
